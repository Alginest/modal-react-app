              ...
              <Grid container className={classes.gridCont}>
                <Grid item className={classes.gridItem}>
                  <Box className={classes.webBack}>
                    <Box className={classes.textBack}>
                      ...
                      <Button className={classes.btnHov} onClick={openModal}>
                        Learn More
                      </Button>
                    </Box>
                ...
                <Grid item className={classes.gridItem}>
                  <Box className={classes.webBack}>
                    ...
                    <img src={webTwo} alt="movie" className={classes.webImg} />
                  </Box>
                </Grid>
                <Grid item className={classes.gridItem}>
                  <Box className={classes.webBack}>
                    <Box className={classes.textBack}>
                      ...
                      <Button className={classes.btnHov}>Learn More</Button>
                    </Box>
                    <img
                      src={webThree}
                      alt="restaurants"
                ...
                <Grid item className={classes.gridItem}>
                  <Box className={classes.webBack}>
                    ...
                    <img src={webFour} alt="blog" className={classes.webImg} />
                  </Box>
                </Grid>
                <Grid item className={classes.gridItem}>
                  <Box className={classes.webBack}>
                ...
                <Grid item className={classes.gridItem}>
                  <Box className={classes.webBack}>
                    ...
                    <img src={webSeven} alt="town" className={classes.webImg} />
                  </Box>
                </Grid>
                <Grid item className={classes.gridItem}>
                  <Box className={classes.webBack}>
